...
def AnalysisRegion(imageName, zoneNum):
    ...
    plt.imshow(plateZones, cmap='gray')
    plt.axis('on')
    plt.show()
...
if __name__ == "__main__":
    ...
    # File path of the image with zones
    ...
    # Rotate the robot and tool by specified angles and calculate safe areas
    ...
    # Create arrays to store safe areas for different angles
    ...
    # Calculate set covering for a specific zone
