...
"""autogenerated by genpy from irobot_fcpp_simul/ExecuteDefectsRepairAction.msg. Do not edit."""
import codecs
import sys
...
class ExecuteDefectsRepairAction(genpy.Message):
  _md5sum = "9cca6e5b7fc942e554e990d84a5b318d"
  _type = "irobot_fcpp_simul/ExecuteDefectsRepairAction"
...
"""
  ...
  _slot_types = ['irobot_fcpp_simul/ExecuteDefectsRepairActionGoal','irobot_fcpp_simul/ExecuteDefectsRepairActionResult','irobot_fcpp_simul/ExecuteDefectsRepairActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ExecuteDefectsRepairAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = irobot_fcpp_simul.msg.ExecuteDefectsRepairActionGoal()
      if self.action_result is None:
        self.action_result = irobot_fcpp_simul.msg.ExecuteDefectsRepairActionResult()
      if self.action_feedback is None:
        self.action_feedback = irobot_fcpp_simul.msg.ExecuteDefectsRepairActionFeedback()
    else:
      self.action_goal = irobot_fcpp_simul.msg.ExecuteDefectsRepairActionGoal()
      self.action_result = irobot_fcpp_simul.msg.ExecuteDefectsRepairActionResult()
      self.action_feedback = irobot_fcpp_simul.msg.ExecuteDefectsRepairActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_i3I().pack(_x.action_goal.goal.defecto_id, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_result.result.reparado
      buff.write(_get_struct_B().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.defecto_id, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_i3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_result.result.reparado,) = _get_struct_B().unpack(str[start:end])
      self.action_result.result.reparado = bool(self.action_result.result.reparado)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
