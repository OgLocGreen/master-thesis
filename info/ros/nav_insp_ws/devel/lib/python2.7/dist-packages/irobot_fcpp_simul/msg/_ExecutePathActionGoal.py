...
"""autogenerated by genpy from irobot_fcpp_simul/ExecutePathActionGoal.msg. Do not edit."""
import codecs
import sys
...
class ExecutePathActionGoal(genpy.Message):
  _md5sum = "cb573e9e289f10b9d43303c76bcd4e87"
  _type = "irobot_fcpp_simul/ExecutePathActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','irobot_fcpp_simul/ExecutePathGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = irobot_fcpp_simul.msg.ExecutePathGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = irobot_fcpp_simul.msg.ExecutePathGoal()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.goal.robot_vel,) = _get_struct_f().unpack(str[start:end])
      return self
