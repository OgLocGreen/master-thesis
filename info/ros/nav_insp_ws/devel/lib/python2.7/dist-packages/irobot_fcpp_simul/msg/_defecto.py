...
"""autogenerated by genpy from irobot_fcpp_simul/defecto.msg. Do not edit."""
import codecs
import sys
...
class defecto(genpy.Message):
  _md5sum = "6f4dca0cbac38a321305ee29edd2c608"
  _type = "irobot_fcpp_simul/defecto"
...
bool reparado
"""
  __slots__ = ['ros_poly','defecto_divpor_zonas','reparado']
  _slot_types = ['geometry_msgs/Polygon','irobot_fcpp_simul/defecto_zona[]','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       ros_poly,defecto_divpor_zonas,reparado
    ...
    """
    if args or kwds:
      super(defecto, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.ros_poly is None:
        self.ros_poly = geometry_msgs.msg.Polygon()
      if self.defecto_divpor_zonas is None:
        self.defecto_divpor_zonas = []
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.defecto_divpor_zonas)
      buff.write(_struct_I.pack(length))
      for val1 in self.defecto_divpor_zonas:
        _v1 = val1.ros_poly
  ...
  def deserialize(self, str):
    ...
    try:
      if self.ros_poly is None:
        self.ros_poly = geometry_msgs.msg.Polygon()
      if self.defecto_divpor_zonas is None:
        self.defecto_divpor_zonas = None
      end = 0
      start = end
      end += 4
      ...
      for i in range(0, length):
        ...
        self.defecto_divpor_zonas.append(val1)
      start = end
      end += 1
      (self.reparado,) = _get_struct_B().unpack(str[start:end])
