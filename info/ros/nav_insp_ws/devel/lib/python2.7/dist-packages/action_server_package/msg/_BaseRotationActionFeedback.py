...
"""autogenerated by genpy from action_server_package/BaseRotationActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class BaseRotationActionFeedback(genpy.Message):
  _md5sum = "8698d7e90e05ffe9ac004cc3583a03da"
  _type = "action_server_package/BaseRotationActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action_server_package/BaseRotationFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BaseRotationActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = action_server_package.msg.BaseRotationFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = action_server_package.msg.BaseRotationFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.feedback.degrees_rotated
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.degrees_rotated,) = _get_struct_f().unpack(str[start:end])
      return self
