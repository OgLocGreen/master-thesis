...
"""autogenerated by genpy from action_server_package/MoveRobotCoordAction.msg. Do not edit."""
import codecs
import sys
...
class MoveRobotCoordAction(genpy.Message):
  _md5sum = "a12799310e2d8b9b1d92ad8c7e60a13f"
  _type = "action_server_package/MoveRobotCoordAction"
...
"""
  ...
  _slot_types = ['action_server_package/MoveRobotCoordActionGoal','action_server_package/MoveRobotCoordActionResult','action_server_package/MoveRobotCoordActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveRobotCoordAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = action_server_package.msg.MoveRobotCoordActionGoal()
      if self.action_result is None:
        self.action_result = action_server_package.msg.MoveRobotCoordActionResult()
      if self.action_feedback is None:
        self.action_feedback = action_server_package.msg.MoveRobotCoordActionFeedback()
    else:
      self.action_goal = action_server_package.msg.MoveRobotCoordActionGoal()
      self.action_result = action_server_package.msg.MoveRobotCoordActionResult()
      self.action_feedback = action_server_package.msg.MoveRobotCoordActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3df().pack(_x.action_goal.goal.movement.x, _x.action_goal.goal.movement.y, _x.action_goal.goal.movement.theta, _x.action_goal.goal.vel))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.movement.x, _x.action_goal.goal.movement.y, _x.action_goal.goal.movement.theta, _x.action_goal.goal.vel,) = _get_struct_3df().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
