...
"""autogenerated by genpy from flexbe_msgs/BehaviorSynthesisActionResult.msg. Do not edit."""
import codecs
import sys
...
class BehaviorSynthesisActionResult(genpy.Message):
  _md5sum = "d13a1c24e611f3c8aae59d09829d044b"
  _type = "flexbe_msgs/BehaviorSynthesisActionResult"
...
string[] state_outcome"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','flexbe_msgs/BehaviorSynthesisResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BehaviorSynthesisActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = flexbe_msgs.msg.BehaviorSynthesisResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = flexbe_msgs.msg.BehaviorSynthesisResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.result.states)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.states:
        _x = val1.state_path
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.result.states.append(val1)
      return self
