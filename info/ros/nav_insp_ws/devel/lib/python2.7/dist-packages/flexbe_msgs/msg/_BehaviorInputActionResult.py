...
"""autogenerated by genpy from flexbe_msgs/BehaviorInputActionResult.msg. Do not edit."""
import codecs
import sys
...
class BehaviorInputActionResult(genpy.Message):
  _md5sum = "fbfb06b1b74139caf57e6c1834fe58bc"
  _type = "flexbe_msgs/BehaviorInputActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','flexbe_msgs/BehaviorInputResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BehaviorInputActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = flexbe_msgs.msg.BehaviorInputResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = flexbe_msgs.msg.BehaviorInputResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.result_code,) = _get_struct_B().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
