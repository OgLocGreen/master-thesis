...
let getImagesFeedback = require('./getImagesFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class getImagesActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new getImagesFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = getImagesFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new getImagesActionFeedback(null);
    ...
    data.feedback = getImagesFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new getImagesActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = getImagesFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new getImagesFeedback()
    }
...
module.exports = getImagesActionFeedback;
