...
class getPartialPanoramaResult {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new getPartialPanoramaResult(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new getPartialPanoramaResult(null);
...
module.exports = getPartialPanoramaResult;
