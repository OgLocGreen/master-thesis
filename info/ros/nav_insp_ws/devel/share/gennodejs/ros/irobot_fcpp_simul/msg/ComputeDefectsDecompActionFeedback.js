...
class ComputeDefectsDecompActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new ComputeDefectsDecompFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ComputeDefectsDecompFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ComputeDefectsDecompActionFeedback(null);
    ...
    data.feedback = ComputeDefectsDecompFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ComputeDefectsDecompActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ComputeDefectsDecompFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ComputeDefectsDecompFeedback()
    }
...
module.exports = ComputeDefectsDecompActionFeedback;
