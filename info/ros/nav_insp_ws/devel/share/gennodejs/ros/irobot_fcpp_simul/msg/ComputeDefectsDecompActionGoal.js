...
class ComputeDefectsDecompActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new ComputeDefectsDecompGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ComputeDefectsDecompGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ComputeDefectsDecompActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = ComputeDefectsDecompGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ComputeDefectsDecompGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ComputeDefectsDecompActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = ComputeDefectsDecompGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new ComputeDefectsDecompGoal()
    }
...
module.exports = ComputeDefectsDecompActionGoal;
