...
class ExecuteDefectsRepairActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new ExecuteDefectsRepairFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ExecuteDefectsRepairFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ExecuteDefectsRepairActionFeedback(null);
    ...
    data.feedback = ExecuteDefectsRepairFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ExecuteDefectsRepairActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ExecuteDefectsRepairFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ExecuteDefectsRepairFeedback()
    }
...
module.exports = ExecuteDefectsRepairActionFeedback;
