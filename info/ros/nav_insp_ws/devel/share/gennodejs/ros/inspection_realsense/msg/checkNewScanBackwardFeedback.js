...
class checkNewScanBackwardFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new checkNewScanBackwardFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new checkNewScanBackwardFeedback(null);
...
module.exports = checkNewScanBackwardFeedback;
