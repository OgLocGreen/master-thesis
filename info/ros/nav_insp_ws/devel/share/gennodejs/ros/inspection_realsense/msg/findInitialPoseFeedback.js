...
class findInitialPoseFeedback {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new findInitialPoseFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new findInitialPoseFeedback(null);
...
module.exports = findInitialPoseFeedback;
