...
struct IROBOT_ir_dataRequest_
{
  ...
  _id_defecto_type id_defecto;
   ...
   typedef int32_t _id_defect_repair_type;
  _id_defect_repair_type id_defect_repair;

   typedef int32_t _id_zona_type;
  _id_zona_type id_zona;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _path_panorama_type;
  _path_panorama_type path_panorama;
...
struct MD5Sum< ::irobot_fcpp_simul::IROBOT_ir_dataRequest_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x910dac130eb554feULL;
  static const uint64_t static_value2 = 0xa27a7f95622859e6ULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::irobot_fcpp_simul::IROBOT_ir_dataRequest_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.id_defect_repair);
      stream.next(m.id_zona);
      stream.next(m.path_panorama);
    }
...
struct Printer< ::irobot_fcpp_simul::IROBOT_ir_dataRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::irobot_fcpp_simul::IROBOT_ir_dataRequest_<ContainerAllocator>& v)
  {
    ...
    s << indent << "id_defect_repair: ";
    Printer<int32_t>::stream(s, indent + "  ", v.id_defect_repair);
    s << indent << "id_zona: ";
    Printer<int32_t>::stream(s, indent + "  ", v.id_zona);
    s << indent << "path_panorama: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.path_panorama);
  }
};
