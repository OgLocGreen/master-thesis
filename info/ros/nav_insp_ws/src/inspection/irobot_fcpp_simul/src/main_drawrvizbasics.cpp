...
//    vector_zonas.push_back(psz);
    ...
    herr_footprint_msg.header.frame_id="reparation_tool_frame";
    ...
    footprint_msg.header.frame_id="summit_xl_base_link";
    ...
    ROS_INFO("LA CHAPA ESTA CON ESTE FRAME, %s", chapa_msg.header.frame_id.c_str());
