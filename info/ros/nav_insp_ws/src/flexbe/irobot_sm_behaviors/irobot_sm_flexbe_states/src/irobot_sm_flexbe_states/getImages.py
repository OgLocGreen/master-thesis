...
class GetImagesState(EventState):
	'''
	...
	def __init__(self):
		...
		super(GetImagesState, self).__init__(outcomes = ['done','failed'], input_keys=['folder_path', 'calib_path', 'id_marker', 'finish'])


		
		self._topic = 'getimages' #Mismo nombre que en el server
		...
		self._client = ProxyActionClient({self._topic: getImagesAction})
	...
	def on_enter(self, userdata):
		...
		goal.calib_path.data = userdata.calib_path
		goal.id_marker = userdata.id_marker
