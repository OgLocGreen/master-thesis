...
from inspection_realsense.msg import moveLeftStepAction, moveLeftStepGoal
...
class moveLeftStep(EventState):
	...
	def __init__(self, vel, step):
		...
		super(moveLeftStep, self).__init__(outcomes = ['done','failed'])
