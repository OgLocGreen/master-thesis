...
class ComputeIRPolyDetectionState(EventState):
    '''
    State to detect polygons and load them in the irobot ir storage service
    ...
    def __init__(self):
        ...
        super(ComputeIRPolyDetectionState, self).__init__(outcomes = ['done', 'failed'])
    ...
    def execute(self, userdata):
        ...
        try:
            ...
            print "Peticion de deteccion de defectos"
            request= IROBOT_ir_dataRequest()

            request.compute_detectpolys=True
