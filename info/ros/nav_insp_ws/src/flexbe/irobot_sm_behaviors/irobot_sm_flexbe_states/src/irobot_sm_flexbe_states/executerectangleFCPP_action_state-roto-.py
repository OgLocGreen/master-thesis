...
class RectangleFCPPActionState(EventState):
	'''
	State that activate the action of doing a fcpp of a rectangle.


	
	># id_zone 	int 	Id of the zone.
	...
	def __init__(self):
		...
		super( RectangleFCPPActionState, self).__init__(outcomes = ['done','failed'],
												 	  input_keys = ['id_zone'])
		...
		self._topic = 'rectanglefcpp' #Aqui mismo topic que en el server
