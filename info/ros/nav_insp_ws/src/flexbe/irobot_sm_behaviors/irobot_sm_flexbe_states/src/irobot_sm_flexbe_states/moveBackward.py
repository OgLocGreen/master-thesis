...
from inspection_realsense.msg import moveBackwardAction, moveBackwardGoal
...
class moveBackward(EventState):
	...
	def __init__(self, pathplanning_vel):
		...
		super(moveBackward, self).__init__(outcomes = ['done','failed'],input_keys=['n_pasadas_ant', 'n_imgs_ant'],output_keys = ['n_pasadas_actuales', 'n_imgs_actuales'])
