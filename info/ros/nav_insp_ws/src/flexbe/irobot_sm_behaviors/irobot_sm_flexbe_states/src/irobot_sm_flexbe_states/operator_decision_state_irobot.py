...
class OperatorDecisionStateIRobot(EventState):
	'''
	...
	def __init__(self):
		...
		Constructor
		'''
		super(OperatorDecisionStateIRobot, self).__init__(outcomes=['seguir','parar','failed'])
	...
	def execute(self, userdata):
		...
		os.system("rosnode kill /moverobotcoord")
		os.system("rosnode kill /executePath_actionserver")
	...
	def on_exit(self, userdata):
		...
		os.system("gnome-terminal -x rosrun action_server_package moverobotcoord_server")
		os.system("gnome-terminal -x rosrun irobot_fcpp_simul executepath_actionserver")
