...
class MergeIRPanoramasState(EventState):
    '''
    State to merge the different panoramas
    ...
    def __init__(self):
        ...
        super(MergeIRPanoramasState, self).__init__(outcomes = ['done', 'failed'], input_keys = ['imgs_path', 'name_0', 'name_180'])
