...
class IROBOT_dimensionsSM(Behavior):
	...
	def create(self):
		...
		_state_machine.userdata.n_imgs1 = 30
		_state_machine.userdata.n_imgs2 = 30
		_state_machine.userdata.folder_path2 = '/home/irobot/imagenesDimensions1/'
		_state_machine.userdata.folder_path1 = '/home/irobot/imagenesDimensions0/'
