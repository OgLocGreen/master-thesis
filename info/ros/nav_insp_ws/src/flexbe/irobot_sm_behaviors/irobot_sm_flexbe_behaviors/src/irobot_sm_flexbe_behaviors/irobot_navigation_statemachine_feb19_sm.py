...
roslaunch spawn_package mpo700_complete_slam_example/factory.launch
	...
	def create(self):
		...
		# x:328 y:413
		_sm_recibiendo_nuevo_goal_0 = OperatableStateMachine(outcomes=['goal_generico'], output_keys=['rviz_goal_pose2D'])
		...
		with _sm_recibiendo_nuevo_goal_0:
			...
			OperatableStateMachine.add('Conversion a Pose2D',
										...
										transitions={'done': 'goal_generico'},
		...
		with _state_machine:
			...
			OperatableStateMachine.add('Recibiendo nuevo goal',
										...
										transitions={'goal_generico': 'Desplazandose a posicion objetivo'},
										autonomy={'goal_generico': Autonomy.Inherit},
										remapping={'rviz_goal_pose2D': 'rviz_goal_pose2D'})
