...
if("TRUE" STREQUAL "TRUE")
  set(prueba_SOURCE_PREFIX /home/irobot/catkin_ws/src/prueba)
  set(prueba_DEVEL_PREFIX /home/irobot/catkin_ws/devel)
  set(prueba_INSTALL_PREFIX "")
  set(prueba_PREFIX ${prueba_DEVEL_PREFIX})
else()
  set(prueba_SOURCE_PREFIX "")
  set(prueba_DEVEL_PREFIX "")
  set(prueba_INSTALL_PREFIX /home/irobot/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'prueba' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'prueba' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/irobot/catkin_ws/src/prueba/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT prueba_NUM_DUMMY_TARGETS)
      set(prueba_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::prueba::wrapped-linker-option${prueba_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR prueba_NUM_DUMMY_TARGETS "${prueba_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::prueba::wrapped-linker-option${prueba_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND prueba_LIBRARIES "${interface_target_name}")
