...
class RectangleCoveragePathPlanningFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RectangleCoveragePathPlanningFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RectangleCoveragePathPlanningFeedback(null);
...
module.exports = RectangleCoveragePathPlanningFeedback;
