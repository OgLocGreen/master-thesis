...
class CompleteRectangleCoverageFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CompleteRectangleCoverageFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new CompleteRectangleCoverageFeedback(null);
...
module.exports = CompleteRectangleCoverageFeedback;
