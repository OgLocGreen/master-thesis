...
class MoveRobotCoordFeedback {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MoveRobotCoordFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveRobotCoordFeedback(null);
...
module.exports = MoveRobotCoordFeedback;
