...
class ExecuteDefectsRepairFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ExecuteDefectsRepairFeedback(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ExecuteDefectsRepairFeedback(null);
    return resolved;
    }
};

module.exports = ExecuteDefectsRepairFeedback;
