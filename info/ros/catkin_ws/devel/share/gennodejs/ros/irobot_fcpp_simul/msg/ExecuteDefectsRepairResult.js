...
class ExecuteDefectsRepairResult {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ExecuteDefectsRepairResult(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ExecuteDefectsRepairResult(null);
...
module.exports = ExecuteDefectsRepairResult;
