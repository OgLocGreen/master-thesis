...
let findCornersFeedback = require('./findCornersFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class findCornersActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new findCornersFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = findCornersFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new findCornersActionFeedback(null);
    ...
    data.feedback = findCornersFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new findCornersActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = findCornersFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new findCornersFeedback()
    }
...
module.exports = findCornersActionFeedback;
