...
let getPolygonsResult = require('./getPolygonsResult.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class getPolygonsActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new getPolygonsResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = getPolygonsResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += getPolygonsResult.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new getPolygonsActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = getPolygonsResult.Resolve(msg.result)
    }
    else {
      resolved.result = new getPolygonsResult()
    }
...
module.exports = getPolygonsActionResult;
