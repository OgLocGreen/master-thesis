...
(cl:defclass <SafetyModuleStatus> (roslisp-msg-protocol:ros-message)
  ((safety_mode
   ...
   (safety_stop
    ...
    :initform cl:nil)
   (safety_overrided
    :reader safety_overrided
    :initarg :safety_overrided
    :type cl:boolean
    :initform cl:nil)
   (lasers_on_standby
   ...
   (speed_at_safety_stop
    :reader speed_at_safety_stop
    :initarg :speed_at_safety_stop
    :type cl:float
    :initform 0.0)
   (lasers_mode
    :reader lasers_mode
...
(cl:defmethod charging-val ((m <SafetyModuleStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs-msg:charging-val is deprecated.  Use robotnik_msgs-msg:charging instead.")
  (charging m))
...
(cl:ensure-generic-function 'safety_overrided-val :lambda-list '(m))
(cl:defmethod safety_overrided-val ((m <SafetyModuleStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs-msg:safety_overrided-val is deprecated.  Use robotnik_msgs-msg:safety_overrided instead.")
  (safety_overrided m))
...
(cl:ensure-generic-function 'speed_at_safety_stop-val :lambda-list '(m))
(cl:defmethod speed_at_safety_stop-val ((m <SafetyModuleStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs-msg:speed_at_safety_stop-val is deprecated.  Use robotnik_msgs-msg:speed_at_safety_stop instead.")
  (speed_at_safety_stop m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SafetyModuleStatus>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'safety_overrided) 1 0)) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'speed_at_safety_stop))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SafetyModuleStatus>) istream)
  "Deserializes a message object of type '<SafetyModuleStatus>"
    ...
    (cl:setf (cl:slot-value msg 'safety_overrided) (cl:not (cl:zerop (cl:read-byte istream))))
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'speed_at_safety_stop) (roslisp-utils:decode-double-float-bits bits)))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SafetyModuleStatus>)))
  ...
  "9229df5d9f5482b79c5ec860392c708b")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SafetyModuleStatus)))
  "Returns md5sum for a message object of type 'SafetyModuleStatus"
  "9229df5d9f5482b79c5ec860392c708b")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <SafetyModuleStatus>))
  ...
  (cl:list 'SafetyModuleStatus
    ...
    (cl:cons ':safety_overrided (safety_overrided msg))
    (cl:cons ':lasers_on_standby (lasers_on_standby msg))
    (cl:cons ':current_speed (current_speed msg))
    (cl:cons ':speed_at_safety_stop (speed_at_safety_stop msg))
