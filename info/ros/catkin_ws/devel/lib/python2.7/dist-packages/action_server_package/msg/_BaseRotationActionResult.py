...
"""autogenerated by genpy from action_server_package/BaseRotationActionResult.msg. Do not edit."""
import codecs
import sys
...
class BaseRotationActionResult(genpy.Message):
  _md5sum = "0945b4d9039ba1fc95b5d03d703eae7e"
  _type = "action_server_package/BaseRotationActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action_server_package/BaseRotationResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BaseRotationActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = action_server_package.msg.BaseRotationResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = action_server_package.msg.BaseRotationResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.final_yaw,) = _get_struct_f().unpack(str[start:end])
      return self
