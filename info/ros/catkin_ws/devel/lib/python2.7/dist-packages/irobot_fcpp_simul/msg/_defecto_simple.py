...
"""autogenerated by genpy from irobot_fcpp_simul/defecto_simple.msg. Do not edit."""
import codecs
import sys
...
class defecto_simple(genpy.Message):
  _md5sum = "9e9103e825e653e77fe6292f6a6f8a76"
  _type = "irobot_fcpp_simul/defecto_simple"
...
float32 y
float32 z"""
  __slots__ = ['ros_poly','direccion_rep','reparado']
  _slot_types = ['geometry_msgs/Polygon','int32','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       ros_poly,direccion_rep,reparado
    ...
    """
    if args or kwds:
      super(defecto_simple, self).__init__(*args, **kwds)
