...
class IROBOT_ir_dataRequest(genpy.Message):
  _md5sum = "4ddaa5ae62cec8855391a0625162d979"
...
float32 z"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_3i().pack(_x.id_poly, _x.id_defecto, _x.id_zona))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.id_poly, _x.id_defecto, _x.id_zona,) = _get_struct_3i().unpack(str[start:end])
      return self
...
class IROBOT_ir_data(object):
  ...
  _md5sum = '7a9f483678423eac1cf4e98d3bca8c59'
