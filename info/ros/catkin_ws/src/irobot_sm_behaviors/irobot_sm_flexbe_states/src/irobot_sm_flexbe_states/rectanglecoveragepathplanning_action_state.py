...
class RectangleCoveragePathPlanningActionState(EventState):
	'''
	...
	def __init__(self, pathplanning_step, pathplanning_distlr, pathplanning_widthlaser, pathplanning_vel):
		...
		super(RectangleCoveragePathPlanningActionState, self).__init__(outcomes = ['done','failed'],
	...
	def on_enter(self, userdata):
		...
		rect_long = userdata.pathplanning_long
		rect_width = userdata.pathplanning_width

		# Create the goal.
		goal = CompleteRectangleCoverageGoal()
		goal.rect_long = long_rectangle
		goal.rect_width = width_rectangle



		goal.step= self._pathplanning_step
		goal.dist_lr= self._pathplanning_distlr
		goal.width_laser= self._pathplanning_widthlaser
