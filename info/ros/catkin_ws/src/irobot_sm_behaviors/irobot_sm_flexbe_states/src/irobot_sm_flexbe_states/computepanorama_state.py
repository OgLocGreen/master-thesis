...
class ComputeIRPanoramaState(EventState):
    '''
    State to compute the panorama
    ...
    def __init__(self):
        ...
        super(ComputeIRPanoramaState, self).__init__(outcomes = ['done', 'failed'])
