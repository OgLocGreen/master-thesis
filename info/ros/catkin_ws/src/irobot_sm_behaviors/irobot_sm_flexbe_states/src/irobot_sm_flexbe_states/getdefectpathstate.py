...
class GetDefectPathState(EventState):
    '''
    ...
    def __init__(self):
        ...
        super(GetDefectPathState, self).__init__(outcomes = ['done', 'failed'], output_keys=['path'])
    ...
    def on_enter(self, userdata):
        ...
        try:
            ...
            request.get_defect_path=True

            response=client(request)

            self._path=response.defect_i_paths
