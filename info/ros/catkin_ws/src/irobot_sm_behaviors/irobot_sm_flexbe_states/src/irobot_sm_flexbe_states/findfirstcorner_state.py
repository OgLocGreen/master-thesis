...
class FindFirstCornerState(EventState):
	...
	def __init__(self):
		...
		super(FindFirstCornerState, self).__init__(outcomes = ['done','failed'], output_keys=['n_imgs1', 'n_imgs2'])
	...
	def on_exit(self, userdata):
		...
		result = self._client.get_result(self._topic)
		userdata.n_imgs1 = result.n_imgs1
		userdata.n_imgs2 = result.n_imgs2
