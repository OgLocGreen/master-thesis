...
class ObtainDimensionState(EventState):
	...
	def __init__(self):
		...
		super(ObtainDimensionState, self).__init__(outcomes = ['done','failed'], input_keys = ['n_imgs', 'folder_path'], output_keys = ['dimension'])


		
		self._topic = 'obtaindimension2' #Mismo nombre que en el server
	...
	def on_enter(self, userdata):
		...
		goal.n_imgs = userdata.n_imgs
		goal.folder_path = userdata.folder_path
