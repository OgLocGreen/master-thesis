...
'''
class IROBOT_navigation_StateMachine_Jun19SM(Behavior):
	'''
	Maquina de estados que coordina los comportamientos implementados hasta junio de 2019.
...
roslaunch spawn_package mpo700_complete_slam_example/factory.launch
	...
	def __init__(self):
		super(IROBOT_navigation_StateMachine_Jun19SM, self).__init__()
		self.name = 'IROBOT_navigation_StateMachine_Jun19'
