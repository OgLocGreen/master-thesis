...
//               res.coordD.x=17.322418-pos_ini_robot_x; res.coordD.y=23.231768-pos_ini_robot_y;
   ...
   //LAB############################################################################
         ...
         case 0:
           ...
           pos_ini_robot_y=0;
           //res.coordA=geometry_msgs::Point(-1.0, 0.0,   0.0);
           res.coordA.x=0.91-pos_ini_robot_x; res.coordA.y=0-pos_ini_robot_y;
           res.coordB.x=0-pos_ini_robot_x; res.coordB.y=0-pos_ini_robot_y;
           res.coordC.x=0-pos_ini_robot_x; res.coordC.y=0.98-pos_ini_robot_y;
           res.coordD.x=0.91-pos_ini_robot_x; res.coordD.y=0.98-pos_ini_robot_y;

        //   //SUSTITUIR POR UNA FUNCIÓN QUE CALCULE DADAS LAS COORDENADAS
           res.long_chapa=0.98;//sqrt(18)
           res.width_chapa=0.91;//sqrt(8)
